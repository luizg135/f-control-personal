    ...
    try:
        ...
        if df.empty:
            ...
            return {
                ...
                'despesas_por_categoria': {}, 'despesas_por_grupo': {}, 'meses_disponiveis': [],
                'por_tipo': {}, 'saldo_mensal': {}, 'transacoes': []
            }
        ...
        df_grafico = df[(df['Data'].dt.year >= 2025) & (~is_ajuste) & (~is_reserva)].copy()
        ...
        dados_finais = {
            ...
            'saldo_mensal': fluxo_mensal.to_dict(),
        ...
        # --- INÍCIO DA CORREÇÃO ---
        # Este bloco precisa ter código com recuo (indentado)
